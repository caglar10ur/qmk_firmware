...
#define DISABLE_MATRIX_SOLID_COLOR                   // Static single hue, no speed support
...
#define DISABLE_RGB_MATRIX_RAINBOW_PINWHEELS	     // Full dual gradients spinning two ssaaahalfs of keyboard
